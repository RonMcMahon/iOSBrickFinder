                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              padding:
                                  EdgeInsetsDirectional.fromSTEB(0, 4, 0, 5),
                              child: StreamBuilder<BricksRecord>(
                                stream: BricksRecord.getDocument(
                                    widget.brickInscription),
                                builder: (context, snapshot) {
                    ...
                    await Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => ShareWidget(
                          passedInscription: '',
                          fullBrickRecord:
                              'I found the brick with the inscription ${detailsBricksRecord.inscription} in Olympic Plaza in Calgary! It is located at Latitude: ${detailsBricksRecord.latitude.toString()} and at Longitude: ${detailsBricksRecord.longitude.toString()} You can also find it between the Key Brick ${detailsBricksRecord.between} and ${detailsBricksRecord.located} This record is printed on page ${detailsBricksRecord.page.toString()} of the Official Brick Record.  Find your favorite bricks at Olympicbricks.com or download the App.',
                        ),
                      ),
                    );
                  },
                          ...
                          FlutterFlowMarker(
                            ...
                            () async {
                              await googleMapsController.future.then(
                                (c) => c.animateCamera(
                                  CameraUpdate.newLatLng(detailsBricksRecord
                                      .latLong
                                      .toGoogleMaps()),
                                ),
                              );
